...
A reproducibility analysis was conducted using this training module. Models were trained a number of times (*n = 10*), and segmentation performance (IoU) was measured after each training run. Training and performance metrics show no variation between training runs.
